...
export default function Insert(props){
	...
	const handleSubmit = async(data) => {
		delete data._id
		var results = await client({url:"/stats-counter/groups",params:{method:"POST",body:data}})
		success(["Success","A new Group record was inserted."]);
		window.location.href = '/stats-counter/admin/departments/groups/'+_id; 
	}
