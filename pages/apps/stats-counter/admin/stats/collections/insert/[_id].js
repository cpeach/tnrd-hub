...
export default function Insert(props){
	...
	const handleSubmit = async(data) => {
		delete data._id
		var results = await client({url:"/stats-counter/collections",params:{method:"POST",body:data}})
		success(["Success","A new Collection record was inserted."]);
		window.location.href = '/stats-counter/admin/groups/collections/'+_id; 
	}
