...
export default function Reports(props) { 
	...
	useEffect(async () => {
		let isMounted = true;
		let _reports = await client({url:'/tnrl-stats/reports/general/people'});
	...
	if(reports){
		...
		l_data.list.columns[4].render = (p)=>{return <Link href={"/tnrl-stats/admin/reports/general/people/"+p}>Edit</Link>}
