...
export default function Reports(props) { 
	...
	useEffect(async () => {
		let isMounted = true;
		let _reports = await client({url:'/tnrl-stats/wifi/reports/usage',params:{method:"POST",body:{}}});
		console.log(reports)
		if(isMounted){
			setReports(_reports)
		}
	...
	if(reports){
		...
		l_data.list.columns[4].render = (p)=>{return <Link href={"/tnrl-stats/admin/reporting/"+p}>Edit</Link>}
