...
export default function Insert(props){
	...
	useEffect(async () => {
		let isMounted = true;
		let _locations = await client({url:'/tnrl-stats/collections/types'});
	...
	const handleSubmit = async(data) => {
		...
		var results = await client({url:"/tnrl-stats/reports/collections/circ",params:{method:"POST",body:data}})
