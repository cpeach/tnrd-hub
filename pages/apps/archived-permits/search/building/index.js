...
export default function Update(props){
	...
	const handleSubmit = async(data) => {
		...
		router.push('/archived-permits/list/building' + qs);
	...
	const handleChange = async(data) => {
		...
		var results = await client({url:"/archived-permits/records/building/search/count",params:{method:"POST",body:{data:search}}})
		//console.log(results);
		console.log(results);
