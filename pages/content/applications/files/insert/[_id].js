...
export default function Insert(props){
	...
	const handleSubmit = async(data) => {
		...
		var results = await client({url:"/hub-console/resource_files",params:{method:"POST",body:data}})
		success(["Success","Your Resource file record was inserted."]);
